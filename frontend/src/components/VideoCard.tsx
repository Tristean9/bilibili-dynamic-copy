...
interface VideoCardProps {
	videoCardData: VideoCardData; // 定义 props 的类型
}

const VideoCard: React.FC<VideoCardProps> = ({ videoCardData }) => {
	return (
            ...
            <div className="bili-video-card__skeleton hide">
				...
				<div className="bili-video-card__wrap __scale-wrap">
					<a
						...
						href={videoCardData.href}
					>
						<div className="bili-video-card__image __scale-player-wrap bili-video-card__image--hover">
							<div className="bili-video-card__image--wrap">
								<picture className="v-img bili-video-card__cover">
									<img src={videoCardData.src}></img>
								</picture>
							</div>
					...
					<div className="bili-video-card__info __scale-disable">
						<div className="bili-video-card__info--right">
							...
							>
								<a
									href="https://www.bilibili.com/video/BV1HM4m1y7Gr?t=7"
									target="_blank"
								>
									{videoCardData.title}
								</a>
